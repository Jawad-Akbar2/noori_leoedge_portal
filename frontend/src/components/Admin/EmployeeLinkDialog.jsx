        ...
        <div className="space-y-6">
          ...
          <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
            <p className="text-sm text-green-800">
              ✓ Employee record has been created in the system. Share the
              onboarding link below with the new employee.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 mb-2">
              Copy this link and send it to {employee.firstName} to complete
              their profile setup.
            </p>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="space-y-1 text-xs text-gray-600">
              ...
              <p>
                <span className="font-medium">Status:</span> Inactive (awaiting
                activation)
              </p>
            </div>
          </div>
